<x-app-layout>
    ...
    <x-slot:title>{{ __('Classroom') }}</x-slot:title>
            ...
            <div class="col-md-2">
                <div class="border rounded p-2 text-center">
                    ...
                    <button onclick="myFunction()" value="{{ $invitation_link }}" id="copy"
                        class="btn btn-sm btn-primary mt-1">{{ __('Get Link') }}
                    </button>
                </div>
            </div>
        </div>
